    ...
    <div className=" relative ">
      <div className="">
        ...
        <div class="sticky top-1 ">
          ...
          <section className=" pt-5 grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-2 px-5  bg-black  ">
...
/>
      ...
      <div class="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
        ...
        <button class="rounded-full bg-neutral-900 py-2 px-3.5 font-com text-sm capitalize text-white shadow shadow-black/60  border ">Voir plus</button>
            ...
            <Link to="/blog">
              <button className=" text-white bg-black  mt-10 mb-10 py-2 px-8  border rounded shadow ">
                Voir plus
              </button>
            </Link>
